...
release = progressbar.__version__
...
texinfo_documents = [
    ('index', project_slug, u'%s Documentation' % project,
     progressbar.__author__, project_slug, 'One line description of project.',
     'Miscellaneous'),
]
...
epub_title = project
epub_author = progressbar.__author__
epub_publisher = progressbar.__author__
